  ...
  return (
    <div className="home-log-in">
          ...
          <div className="menu-navbar-atas">
            <div className="item">
              <div className="link-3">
                <img className="SVG-2" alt="Svg" src="https://c.animaapp.com/IMLcrDb6/img/svg-13.svg" />
                <div className="text-wrapper-27">Pijar Prakerja</div>
              </div>
            </div>
            <div className="item">
              <div className="link-3">
                <img className="SVG-2" alt="Svg" src="https://c.animaapp.com/IMLcrDb6/img/svg-14.svg" />
                <div className="text-wrapper-27">Pijar Mahir for Business</div>
              </div>
            </div>
            <div className="item">
              <div className="link-3">
                <img className="SVG-2" alt="Svg" src="https://c.animaapp.com/IMLcrDb6/img/svg-15.svg" />
                <div className="text-wrapper-27">Pijar Camp</div>
              </div>
            </div>
            <div className="item">
              <div className="link-3">
                <img className="SVG-2" alt="Svg" src="https://c.animaapp.com/IMLcrDb6/img/svg-16.svg" />
      ...
      <div className="konten">
        <BannerHome bannerAtas="https://c.animaapp.com/IMLcrDb6/img/banner-atas-4.png" varian="new-features" />
        <div className="kategori-kursus-2">
          ...
          <KategoriKursus
            ...
            text="Mahir Digital"
          />
          <KategoriKursus hover="off" rectangle="https://c.animaapp.com/IMLcrDb6/img/rectangle-4-5@2x.png" text="UKM" />
          <KategoriKursus
        ...
        <div className="freemium-paid">
          <div className="inovasi-grup">
            ...
            <button className="button-2">
              <div className="text-wrapper-32" onClick={handleClickKategoriFilter} style={{ cursor: "pointer" }}>Lihat Semua</div>
            </button>
        ...
        <div className="div-2">
          ...
          <div className="paid-courses">
            ...
            <div className="text-wrapper-36" onClick={handleClickKategoriFilter} style={{ cursor: "pointer" }}>Lihat Semua</div>
        </div>
        <div className="div-2">
          ...
          <div className="text-wrapper-34"onClick={handleClickKategoriFilter} style={{ cursor: "pointer" }}>Lihat Semua</div>
        </div>
        ...
        <div className="div-2">
          ...
          <div className="paid-courses">
            ...
            <div className="text-wrapper-35" onClick={handleClickKategoriFilter} style={{ cursor: "pointer" }}>Lihat Semua</div>
        </div>
