    ...
    <div className="detail-kursus">
      <div className="overlap-2">
        <img
          ...
          src="https://c.animaapp.com/IMLcrDb6/img/rectangle-8-25@2x.png"
        />
        <div className="rectangle-3" />
           
        <div className="frame-20">
          <DetailHargaKursus className="detail-harga-kursus-instance" varian="reg-paid" />
          <div className="frame-21">
            <div className="frame-22">
              <div className="informasi-kursus">
                ...
                <div className="frame-23">
                  <p className="text-wrapper-32">Marketing with Google Ads & YouTube</p>
              ...
              <div className="info" id="info-paid">
                <div className="frame-31">
                  <img className="gg-info" alt="Gg info" src="https://c.animaapp.com/GRpL3tEH/img/group@2x.png" />
                  <div className="text-wrapper-38-1" >Info</div>
                </div>
                <div className="sertifikat-dan-wrapper">
                  <p className="sertifikat-dan">
                    <span className="text-wrapper-39-1">Proses pembelajaran dilakukan </span>
                    <span className="text-wrapper-39-1">di platform mitra.</span>
                    <span className="text-wrapper-39-1">Arahan dan akses terbuka </span>
                    <span className="text-wrapper-39-1">setelah pembayaran.</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="detail-materi-course">
              ...
              <div className="ellipse-1" style={{ backgroundColor: "var(--foundation-pijar-orangep300)"}}/>
                  <div className="text-wrapper-4">Materi Pelatihan</div>
              </div>
              <MateriPelatihan varian="reg-paid" />
