    ...
    <div className="review-Project">
      ...
      <div className="konten">
            ...
            <div className="overlap-group-4-1">
              ...
              <div className="frame-12">
                ...
                <div className="frame-14">
                  ...
                  <div className="text-wrapper-26-1">Project telah direview</div>
                </div>
              </div>
        ...
        <div className="tab-menu-summary">
          <TabMenu rightText="Review Project" leftText="Review CV" varian="kanan-aktif"
          />
          <div className="summary">
            <div className="frame-15">
              ...
              <Button  text="Lihat Hasil" varian="short-big-outline" style={{ width : "150px", right : "30px" }}/>
        ...
        <div className="deskripsi-upload">
          ...
          <div className="upload-testimoni">
            <div className="upload">
              <div className="info" style={{ height : "90px"}}>
                ...
                <div className="silakan-unggah-CV-wrapper">
                  <p className="silakan-unggah-CV">Silakan&nbsp;&nbsp;pilih kategori project kamu dan unggah CV kamu melalui kotak di bawah ini</p>
                </div>
              </div>
              <div class="custom-dropdown-container">
                <label for="kategori" class="custom-dropdown-label">Kategori Project</label>
                <select id="kategori" class="custom-dropdown-select">
